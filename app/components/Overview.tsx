...
const Overview = () => {
  ...
  return (
    <div className='bg-gray-100 py-32'>
      <div className='max-w-8xl flex flex-col md:flex-row mx-auto gap-20 md:gap-60 py-20 justify-center'>
        <motion.div 
        initial= {{filter: 'blur(4px)', opacity: 0}}
        whileInView= {{filter: 'blur(0px)', opacity: 1}}
        transition={{ delay: 1, duration: 2, ease: "easeInOut",}}
        >
          <p className='font-thin text-sm text-center md:text-left'>Overview</p>
          <p className='text-sm text-center md:text-left'>What&apos;s Augen </p>
        </motion.div>
        <motion.div 
        ...
        className='max-w-lg'>
          <p className='text-2xl font-light text-center md:text-left px-12 md:px-0'>Augen is the first-of-its-kind AI Wearable
            Company bringing general-purpose devices
          </p>
          <div className='text-blue-500 text-2xl font-light text-center md:text-left px-10 md:px-0'>
          ...
          <div className='flex items-center gap-5 pt-20 justify-center md:justify-start'>
          <motion.div
