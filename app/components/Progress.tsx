    ...
    <div className="bg-[#0F1012]">
      <div className="py-20">
        <motion.p
          ...
          className=" max-w-4xl pl-10 mx-auto text-sm font-thin text-white py-10 "
        >
          Our Progress
        </motion.p>
        <div className="max-w-4xl mx-auto flex flex-col md:flex-row pl-10 gap-20 gap:gap-40 ">
          <motion.div
            ...
            transition={{ delay: 1.1, duration: 1.2, ease: "easeIn" }}
          >
            <h2 className="text-2xl font-light  text-white pb-6">
              The new Method
            </h2>
          ...
          <div>
            ...
            >
              ...
              cutting-edge wearable technologies such as A¹ Sense, B¹ Eye, and
              A¹ Neuro.
            </motion.p>
            <motion.p
              initial={{ y: 100, opacity: 0 }}
            ...
            >
              ...
              enhancing the human experience, our company leads in the fields of
              Invisible Sense, Spatial, and Neural Computing, aiming for a
              future where technology amplifies human potential and makes every
      ...
      <div className="py-20">
        ...
        <div className="max-w-4xl mx-auto flex flex-col md:flex-row pl-10 gap-20 md:gap-40 ">
          <motion.div
            ...
            transition={{ delay: 1.1, duration: 1.2, ease: "easeIn" }}
          >
            <h2 className="text-2xl font-light max-w-[12rem] text-white pb-6">
