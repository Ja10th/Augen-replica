...
export default function Hero() {
  return (
    <div className='relative'>
      ...
      >
        <img src="Augen.webp" alt="Augen heading" className='h-screen object-cover' />
      ...
      <div
        className='flex items-center rounded-xl absolute top-24 left-1/2 transform -translate-x-1/2 bg-gray-100 p-2 cursor-pointer group'
      >
        <motion.p
      ...
      >
        ...
        <div className='flex pt-4 gap-1'>
          ...
          <button className='text-blue-400 font-extralight border border-blue-400 px-3 text-sm rounded-2xl'>A<sup>1</sup>Sense</button>
          <button className='text-blue-400 font-extralight border border-blue-400 px-3 text-sm rounded-2xl'>B<sup>1</sup>Eye</button>
          <button className='text-blue-400 font-extralight border border-blue-400 px-3 text-sm rounded-2xl'>A<sup>1</sup>Neuro</button>
        </div>
      </motion.div>
