    ...
    <div className="bg-white py-20">
      ...
      <div className="relative">
        <motion.h1
          ...
          className="text-[10rem] leading-tight mx-auto py-16 font-light text-blue-500 text-center max-w-3xl"
        >
          Wearable Devices
        </motion.h1>
      ...
      <div className="flex max-w-4xl gap-60 pl-8 mx-auto py-20  ">
        <motion.div
          ...
          transition={{ delay: 1.2, duration: 1.5, ease: "easeInOut" }}
        >
          <p className="text-gray-500 max-w-xs pb-6">
        ...
        <div className="pl-20 pt-4">
          <p className="text-sm text-right pb-6">Explore in depth</p>
          <div>
