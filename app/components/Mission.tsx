...
const Mission = () => {
  return (
    <div className='bg-[#161719] py-20 relative'>
        ...
        <div 
        className='flex max-w-8xl mx-auto gap-60  py-20 justify-center'>
            <motion.div 
            ...
            >
                ...
                <p className='text-2xl font-light text-gray-200'>Be the future of next-gen computing technologies</p>
